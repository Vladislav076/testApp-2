...
class ProfileVC: UIViewController {
    ...
    fileprivate var skillsArr: [String] = []
    ...
    private func createLayout() -> UICollectionViewCompositionalLayout {
        return UICollectionViewCompositionalLayout {(sectionNumber, env) -> NSCollectionLayoutSection? in
            ...
            return section
                ...
                let item = NSCollectionLayoutItem( layoutSize: NSCollectionLayoutSize(widthDimension: .estimated(40), heightDimension: .absolute(44)))
                item.contentInsets.trailing = 0
                item.contentInsets.leading = 0
                item.contentInsets.top = 0
                
                let group = NSCollectionLayoutGroup.horizontal( layoutSize: .init(widthDimension: .fractionalWidth(1.0), heightDimension: .estimated(50)), subitems: [item])
...
extension ProfileVC: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 0:
            ...
            mainInfoCell.configureCell(name: person.name,
        ...
        case 2:
            ...
            descriptionCell.configureCell(info: person.aboutPerson)
